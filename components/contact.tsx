...
const Contact = () => {
  return (
    <section id="contact" className="w-full my-10 p-5 md:px-10 lg:py-25">
      <div className="flex flex-col gap-4 items-center lg:px-70">
        <motion.span
          ...
          className="px-2 py-1 text-xs border rounded-full border-primary text-primary"
        >
          Contact us
        </motion.span>
        ...
        <motion.span
          ...
          viewport={{ once: true }}
          variants={textVariants}
          className="text-3xl text-center font-medium md:text-7xl text-foreground"
        >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          variants={textVariants}
          className="tracking-[-2%] text-[10px] lg:text-lg px-15 text-center text-muted-foreground"
        >
          Enter any enquiries or issues you have and we will respond swiftly.
        </motion.p>
      </div>

      <div className="relative flex items-center justify-center mt-5 px-4 sm:px-6">
        {/* Main center card container */}
        <div className="relative bg-[#00000005] w-full max-w-[280px] md:max-w-md lg:max-w-lg">
          {/* Left wing */}
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <Input
                  ...
                  className="w-full px-3 py-2 md:text-sm bg-black/5 border border-black/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              <div className="flex flex-col gap-2">
                ...
                <Textarea
                  ...
                  className="w-full px-3 py-2 md:text-sm bg-black/5 border border-black/10 rounded-lg md:min-h-[130px] focus:outline-none focus:ring-2 focus:ring-primary/50 "
                />
              </div>
